  ...
  />*/}
     <TouchableHighlight
      ...
      <Text style={{textAlign: "center"}}>การใช้ Modal</Text>
                    <Modal
                        animationType="none" // fade, slide, none
                        transparent={true}
                    ...
                    <Button title='Go to Profile' onPress={() => router.push("/textinputdemo")} />
                    <Button title='Go to Switch' onPress={() => router.push("/switchdemo")} />
                    <Button title='Go to Flatlistdemo' onPress={() => router.push("/flatlistdemo")} />
                    <Button title='Go to Profile' onPress={() => router.push("/proflie")} />
